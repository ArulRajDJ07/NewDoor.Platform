...
{
    public class DoWhattaProductDBContext : ApplicationDbContext
    {
        private readonly IUserContextProvider _currentContextProvider;

        public DoWhattaProductDBContext(
            DbContextOptions<DoWhattaProductDBContext> options,
        ...
        {
            var markerType = typeof(IProductDbContextMarker);
